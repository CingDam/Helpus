				...
				<nav
					...
					<div class="navbar-nav-right d-flex align-items-center"
						...
						<ul class="navbar-nav flex-row align-items-center ms-auto">
							...
							<li class="nav-item navbar-dropdown dropdown-user dropdown">
								<a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
									<img src="../img/${sessionScope.company.coProfile }" class="w-px-40 h-px-40 rounded-circle btn-secondary" />
								</a>
								<ul class="dropdown-menu dropdown-menu-end">
									<li><a class="dropdown-item" href="#">
											<div class="d-flex">
												<div class="flex-shrink-0 me-3">
													<img src="../img/${sessionScope.company.coProfile }" class="w-px-40 h-px-40 rounded-circle shadow-sm" />
												</div>
												<div class="flex-grow-1">
													<small class="text-muted">대전 동구</small>
													<span class="fw-semibold d-block">${sessionScope.company.coName }</span>
											</div>
									</a></li>
									<li>
										<div class="dropdown-divider"></div>
