                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-5 row">
                            ...
                            <div class="col-md-10 tag">
                                <div class="badge rounded-pill bg-label-secondary">에어컨 청소</div>
                                <div class="badge rounded-pill bg-label-secondary">세탁기 청소</div>
                                <div class="badge rounded-pill bg-label-secondary">건조기 청소</div>
                            </div>
                        </div>
